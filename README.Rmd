...
The goal of shinyFlash is to provide easy to use, interactive flash cards to help you study! This package contains two primary functions: `flash_cards` and `flash_addin`. These two functions will allow you to generate flash cards either in a shiny app or in an interactive RStudio addin. 
